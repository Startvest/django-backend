...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='startup',
            name='funding_stage',
            field=models.CharField(choices=[('Pre-seed', 'Pre-seed'), ('Series A', 'Series A'), ('Series B', 'Series B'), ('Series C', 'Series C')], default='Pre-seed', max_length=200),
        ),
        migrations.AddField(
            model_name='startup',
        ...
        migrations.AlterField(
            model_name='startup',
            name='logo',
            field=models.ImageField(null=True, upload_to='startups/logos'),
        ),
        migrations.AlterField(
            model_name='startup',
            name='pitch',
            field=models.FileField(null=True, upload_to='startups/pitches'),
        ),
    ]
